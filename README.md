...
<body>
  ...
  <div class="box" id="box">
    ...
    <button class="no" id="noBtn" onmouseover="noHover()">No 🙄</button>
    <p id="message"></p>
  </div>

  <script>
    const noBtn = document.getElementById("noBtn");
    const messages = ["HEY!", "NOPE!", "TRY AGAIN 😜", "EXCUSE ME?!"];
    ...
    function yesClicked() {
      document.getElementById("box").innerHTML =
        "<h1>YAY!!! 💖🥰</h1><p>You’re officially my Valentine 😏</p>";
      confettiBoom();
    }
    ...
    function confettiBoom() {
      for (let i = 0; i < 120; i++) {
        ...
        confetti.style.backgroundColor =
          ["#ff3b6f", "#ffd166", "#06d6a0", "#118ab2"][Math.floor(Math.random() * 4)];
